...
test:
	...
	@mkdir -p ${PROJECT_ROOT}/Resources/test/
	@echo "root.tests_enabled = true;" > ${PROJECT_ROOT}/Resources/test/enabled.js
	@make launch-titanium
...
launch-titanium:
	...
	@mkdir -p ${PROJECT_ROOT}/build/iphone/
	@PROJECT_NAME=CrowdtapMobile PROJECT_ROOT=${PROJECT_ROOT} DEVICE_TYPE=${DEVICE_TYPE} bash ${PROJECT_ROOT}/bin/titanium.sh
